  ...
  return (
    <div className={style.footer}>
      <div className={style.footerTop}>
        ...
        <div className={style.ftBox} style={{ marginRight: '30px' }}>
          <Image
            src="/images/icon/wx.jpg"
            alt="logo"
            height={'30'}
            width={'135'}
          />
        ...
        <div className={style.ftBox}>
          <Image
            src={'/images/icon/dy.jpg'}
            alt="logo"
            height={'30'}
            width={'135'}
          />
          <div className={style.wx}>官方抖音</div>
        </div>
      </div>
      <div className={style.footerBot}>
        Copyright © 2023
        梵华莲花(武汉)农业发展有限公司(fanhualianhua.top)版权所有 备案号：
