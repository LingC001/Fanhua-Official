  ...
  return (
    <div className={style.index}>
      ...
      <div className="section-row">
        ...
        <div className="desc">
          梵华莲花（武汉）农业发展有限公司成立于2012年10月15日，注册地位于湖北省咸宁市嘉鱼县陆溪镇界石村三组，法定代表人为刘艳琴。
          经营范围包括农产品、物联网技术研发；农业技术转让服务、开发服务、咨询、交流服务；农业科技信息推广服务；农业项目、旅游项目开发；
          有机肥料及微生物肥料、农副产品、农产品、蔬菜、预包装食品、农作物种子销售；农业项目规划、林业规划设计；林业科学研究服务；
          物联网技术服务；畜牧业科学研究服务；物联网技术咨询；货物及技术进出口；旅游管理服务；物业管理；土地整理、复垦；土壤修复；
          环保信息咨询；土地规划咨询；谷物、蔬菜种植销售；水产品、畜禽的养殖。
        </div>
      </div>
